...
import 'components/imageFileContainer.dart';
            ...
            child: Column(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.fromLTRB(30, 0, 30, 0),
                  child: Wrap(children: [
                    for (ImageFile item in createPublishService.images)
                      if (item != null)
                        Stack(children: [
                          ...
                          Positioned(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  createPublishService.images.removeWhere(
                                      (element) => element == item);

                                  //createPublishService.images.remove(item);
                                });
                              },
                            ),
                          ),
                    ...
                    onPressed: () {
                      ...
                      http.post(
                        ...
                        body: jsonEncode(<String, String>{
                          ...
                          'species':
                              createPublishService.specieSelected.id.toString(),
